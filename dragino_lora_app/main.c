 ...
 *  4.2. type in terminal "./dragino_lora_app sender KONNICHIWA",  then you can transmit KONNICHIWA via lroa
 *  4.3. type in terminal "./dragino_lora_app 0" (0 is meaningless), then you can receive message with lora
 * 
 * @warning you have to configure Frequency and SF values to communicate others.
 *
 *******************************************************************************/
...
sf_t sf = SF7;                                          /*********Config here**********/

// Set center frequency, forAS923
//uint32_t  freq = 868100000; // in Mhz! (868.1)
uint32_t  freq = 923200000; // in Mhz! (923.2)          /*********Config here**********/

byte hello[32] = "HELLO";//message of transmitted

//tranceiver main function
...
//receive a packet via lora here
void receivepacket() {
...
//transmit a packet via lora here
